...
export default class TabletRtiPage {
    ...
    constructor(public page: Page) {
        ...
        this.baggageChecked = this.page
            .getByRole('group', { name: 'extras item' })
            .filter({
            has: this.page.getByRole('heading', { name: 'Baggage', level: 5 })
        });
        ...
        this.chekcedBag = this.page.getByRole('button', { name: 'Checked - $35 / leg' })
        this.secondChekcedBag = this.page.getByRole('button', { name: 'Checked - $35 / leg' }).nth(0);
